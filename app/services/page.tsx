        ...
        <div className="">
            ...
            <div className={styles.gradient}>
                {servicesData.map((data, idx) => {
                    ...
                    if (idx % 2 == 0 && idx % 4 == 2) return (
                        <div key={idx} >
                            <FullsizeCard1 key={idx} title={data.title} description={data.description} iconLink={data.iconLink} />
                    ...
                    return (
                        <FullsizeCard2 key={idx} title={data.title} description={data.description} iconLink={data.iconLink} />
                    )
